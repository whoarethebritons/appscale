...
class TestAppManager(unittest.TestCase):
  ...
  def test_choose_db_location(self):
    ...
    self.assertEqual("127.0.0.1", app_manager_server.choose_db_location(db_locations, 80))
    db_locations = ['127.0.0.1', '127.0.0.2']
    assert  app_manager_server.choose_db_location(db_locations, 80) in db_locations
    self.assertRaises(ValueError, app_manager_server.choose_db_location, [], 80)
